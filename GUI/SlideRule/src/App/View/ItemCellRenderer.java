...
public class ItemCellRenderer extends JLabel implements ListCellRenderer {
    ...
    public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
        ...
        ImageIcon imageIcon = new ImageIcon("C:\\digitkomp gaphor\\lehozook_git\\Lehozook\\GUI\\SlideRule\\resources\\items\\"+type.toLowerCase()+".png"); // load the image to a imageIcon
